...
| 1     | F2-W2       | Read model active package + departure                  | MH-MVP   | 120      | S1    | S1-E-02   | BL-CAT-001     | E     | in progress | BL-JNT-001..004; BL-EGV-001; BL-LGV-001 | `list/detail` only shows valid package/departure                    |
