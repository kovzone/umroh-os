...
| 1     | S1-E-01     | Seat concurrency + DB transaction review (for `S1-J-03`) | MH-MVP   | 105      | S1    | S1-E-01   | BL-EGV-001     | E     | todo   | BL-JNT-003                         | “Approved” comment on contract or PR review per **05**              |
| 1     | S1-L-01     | S1 wireframe / screen list (URL + main components)     | MH-MVP   | 106      | S1    | S1-L-01   | BL-LGV-001     | L     | todo   | BL-JNT-001                         | Figma link or bullets in `slice-S1.md` / contract per **05**        |
| 1     | F1-W1       | Internal login + refresh token flow                    | MH-MVP   | 110      | S1    | S1-E-04   | BL-IAM-001     | E     | todo   | BL-JNT-001..004; BL-EGV-001; BL-LGV-001 | Login succeeds, refresh works, unauthorized → 401                   |
| 1     | F1-W3       | `CheckPermission` middleware for internal routes       | MH-MVP   | 111      | S1    | S1-E-04   | BL-IAM-002     | E     | todo   | BL-JNT-001..004; BL-EGV-001; BL-LGV-001 | Finance routes denied for non-finance roles                         |
| 1     | F1-W5       | Basic suspend/revoke session                           | MH-MVP   | 112      | S1    | S1-E-04   | BL-IAM-003     | E     | todo   | BL-JNT-001..004; BL-EGV-001; BL-LGV-001 | Suspended user cannot access again                                  |
| 1     | F1-AC       | Audit log for state-changing calls                     | MH-MVP   | 113      | S1    | S1-E-04   | BL-IAM-004     | E     | todo   | BL-JNT-001..004; BL-EGV-001; BL-LGV-001 | Create/update booking actions recorded in audit                     |
| 1     | F2-W2       | Read model active package + departure                  | MH-MVP   | 120      | S1    | S1-E-02   | BL-CAT-001     | E     | todo   | BL-JNT-001..004; BL-EGV-001; BL-LGV-001 | `list/detail` only shows valid package/departure                    |
...
| 1     | F4-UI       | Catalog → detail → booking form UI                     | MH-MVP   | 140      | S1    | S1-L-02   | BL-FE-BOOK-001 | L     | todo   | BL-JNT-001..004; BL-EGV-001; BL-LGV-001 | User can reach booking form from catalog                            |
| 1     | F4-UI       | FE integration to catalog API                          | MH-MVP   | 141      | S1    | S1-L-03   | BL-FE-BOOK-002 | L     | todo   | BL-JNT-001..004; BL-EGV-001; BL-LGV-001 | FE calls list/detail per contract                                   |
