...
| 1     | S1-E-12     | Move iam client-facing REST (`/v1/sessions*`, `/v1/me*`, `/v1/users*`) to `gateway-svc`; add matching iam gRPC RPCs | MH-MVP | 147 | S1 | S1-E-12 | BL-IAM-018 | E | in progress | BL-JNT-001..004; BL-EGV-001; BL-LGV-001; BL-MON-001; BL-GTW-001 | Login/logout/refresh/me flow through `gateway-svc:4000`; `services/iam-svc/api/rest_oapi/` removed |
