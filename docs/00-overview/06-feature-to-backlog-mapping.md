...
| 1     | F1-W1       | Internal console login page (`/console/login`) + session entry flow     | MH-MVP   | 126      | S1    | S1-L-07   | BL-FE-CONSOLE-001 | L  | todo   | BL-JNT-001..004; BL-EGV-001; BL-LGV-001; BL-IAM-001..004 | Valid credentials enter console; invalid credentials stay on login with error feedback |
| 1     | F1-W3       | Internal console shell (`/console`) with full sidemenu + 403 handling   | MH-MVP   | 127      | S1    | S1-L-08   | BL-FE-CONSOLE-002 | L  | todo   | BL-JNT-001..004; BL-EGV-001; BL-LGV-001; BL-IAM-001..004; BL-FE-CONSOLE-001 | Authenticated staff sees admin shell; permission-denied route returns 403 page/state |
...
| 1     | S1-E-08     | Monitoring migration — standard `grpc.health.v1.Health`, admin `/metrics` HTTP, docker `grpc_health_probe` (ADR 0009) | MH-MVP | 143 | S1 | S1-E-08 | BL-MON-001 | E | todo | BL-JNT-001..004; BL-EGV-001; BL-LGV-001 | Pilot service (`catalog-svc`) is green on Prometheus / Grafana / compose health checks under gRPC-only shape |
