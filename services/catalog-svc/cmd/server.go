...
// runGrpcServer runs the gRPC server exposing the CatalogService surface plus
// the standard gRPC health protocol. Per ADR 0009 this is catalog-svc's only
// transport — the public REST routes moved to gateway-svc (G6 / S1-E-10) and
// the backend REST package was removed in G7 / S1-E-11.
