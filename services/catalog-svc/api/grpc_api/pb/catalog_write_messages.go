...
// S1-E-07 / BL-CAT-014 staff write quartet and the S1-J-03 inventory duo.
//
// NOTE: needs make genpb — these types would normally be generated by protoc
// into catalog.pb.go. They are written by hand here because protoc is not
...
// handler code in catalog_write.go compiles unchanged once regenerated.
package pb
...
// ReserveSeatsRequest mirrors the proto message.
type ReserveSeatsRequest struct {
	ReservationId       string
	DepartureId         string
	Seats               int32
	IdempotencyTtlHours int32
}
...
func (x *ReserveSeatsRequest) GetDepartureId() string {
	if x == nil {
		return ""
	}
...
func (x *ReserveSeatsRequest) GetIdempotencyTtlHours() int32 {
	if x == nil {
		return 0
	}
	return x.IdempotencyTtlHours
}

// Reservation is the idempotency record.
...
func (x *Reservation) GetDepartureId() string {
	if x == nil {
		return ""
	}
	return x.DepartureId
}
func (x *Reservation) GetSeats() int32 {
	if x == nil {
		return 0
	}
	return x.Seats
}
func (x *Reservation) GetReservedAt() string {
	if x == nil {
		return ""
	}
	return x.ReservedAt
...
// ReserveSeatsResponse mirrors the proto message.
...
func (x *ReserveSeatsResponse) GetReplayed() bool {
	if x == nil {
		return false
	}
	return x.Replayed
...
// ReleaseSeatsRequest mirrors the proto message.
...
func (x *ReleaseSeatsRequest) GetReservationId() string {
	if x == nil {
		return ""
	}
	return x.ReservationId
}
func (x *ReleaseSeatsRequest) GetSeats() int32 {
	if x == nil {
		return 0
	}
	return x.Seats
}
func (x *ReleaseSeatsRequest) GetReason() string {
	if x == nil {
		return ""
	}
	return x.Reason
...
// Released is the release confirmation record.
...
func (x *Released) GetReservationId() string {
	if x == nil {
		return ""
	}
	return x.ReservationId
}
func (x *Released) GetDepartureId() string {
	if x == nil {
		return ""
	}
	return x.DepartureId
}
func (x *Released) GetSeatsReleased() int32 {
	if x == nil {
		return 0
	}
	return x.SeatsReleased
}
func (x *Released) GetReleasedAt() string {
	if x == nil {
		return ""
	}
	return x.ReleasedAt
...
// ReleaseSeatsResponse mirrors the proto message.
...
func (x *ReleaseSeatsResponse) GetReleased() *Released {
	if x == nil {
		return nil
	}
	return x.Released
}
func (x *ReleaseSeatsResponse) GetRemainingSeats() int32 {
	if x == nil {
		return 0
	}
	return x.RemainingSeats
}
func (x *ReleaseSeatsResponse) GetReplayed() bool {
	if x == nil {
		return false
	}
	return x.Replayed
