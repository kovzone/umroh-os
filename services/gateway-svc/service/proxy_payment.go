...
// GetPaymentSystemLive proxies a liveness probe to payment-svc through the REST
...
func (s *Service) GetPaymentSystemLive(ctx context.Context) (*payment_rest_adapter.LivenessResult, error) {
	const op = "service.Service.GetPaymentSystemLive"
	...
	result, err := s.adapters.paymentRest.GetSystemLive(ctx)
	if err != nil {
