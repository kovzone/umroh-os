...
// GetOpsSystemLive proxies a liveness probe to ops-svc through the REST
...
func (s *Service) GetOpsSystemLive(ctx context.Context) (*ops_rest_adapter.LivenessResult, error) {
	const op = "service.Service.GetOpsSystemLive"
	...
	result, err := s.adapters.opsRest.GetSystemLive(ctx)
	if err != nil {
