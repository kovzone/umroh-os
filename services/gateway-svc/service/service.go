...
type IService interface {
	...
	// CRM depth — Wave 7 (BL-CRM-010..012, 017..066) — bearer required.
	RegisterAgent(ctx context.Context, params *crm_grpc_adapter.RegisterAgentParams) (*crm_grpc_adapter.AgentAdapterResult, error)
	SubmitAgentKyc(ctx context.Context, params *crm_grpc_adapter.SubmitAgentKycParams) (*crm_grpc_adapter.KycAdapterResult, error)
	SignAgentMoU(ctx context.Context, params *crm_grpc_adapter.SignAgentMoUParams) (*crm_grpc_adapter.MoUAdapterResult, error)
	GetAgentProfile(ctx context.Context, agentId string) (*crm_grpc_adapter.AgentAdapterResult, error)
	GetReplicaSite(ctx context.Context, agentId string) (*crm_grpc_adapter.ReplicaSiteAdapterResult, error)
	UpdateReplicaSite(ctx context.Context, params *crm_grpc_adapter.UpdateReplicaSiteParams) (*crm_grpc_adapter.ReplicaSiteAdapterResult, error)
	GetSocialShareLink(ctx context.Context, params *crm_grpc_adapter.GetSocialShareLinkParams) (*crm_grpc_adapter.ShareLinkAdapterResult, error)
	GenerateBusinessCard(ctx context.Context, params *crm_grpc_adapter.GenerateBusinessCardParams) (*crm_grpc_adapter.BusinessCardAdapterResult, error)
	ListContentBank(ctx context.Context, params *crm_grpc_adapter.ListContentBankParams) (*crm_grpc_adapter.ListContentBankResult, error)
	CreateContentAsset(ctx context.Context, params *crm_grpc_adapter.CreateContentAssetParams) (*crm_grpc_adapter.ContentAssetRowResult, error)
	WatermarkFlyer(ctx context.Context, params *crm_grpc_adapter.WatermarkFlyerParams) (*crm_grpc_adapter.WatermarkFlyerResult, error)
	ListProgramGallery(ctx context.Context, params *crm_grpc_adapter.ListProgramGalleryParams) (*crm_grpc_adapter.ListProgramGalleryResult, error)
	SetTrackingCode(ctx context.Context, params *crm_grpc_adapter.SetTrackingCodeParams) (*crm_grpc_adapter.TrackingCodeAdapterResult, error)
	GetAdsManagerStats(ctx context.Context, params *crm_grpc_adapter.GetAdsManagerStatsParams) (*crm_grpc_adapter.AdsStatsAdapterResult, error)
	CreateUtmLink(ctx context.Context, params *crm_grpc_adapter.CreateUtmLinkParams) (*crm_grpc_adapter.UtmLinkAdapterResult, error)
	ListUtmLinks(ctx context.Context, params *crm_grpc_adapter.ListUtmLinksParams) (*crm_grpc_adapter.ListUtmLinksResult, error)
	CreateLandingPage(ctx context.Context, params *crm_grpc_adapter.CreateLandingPageParams) (*crm_grpc_adapter.LandingPageAdapterResult, error)
	ListLandingPages(ctx context.Context, params *crm_grpc_adapter.ListLandingPagesParams) (*crm_grpc_adapter.ListLandingPagesResult, error)
	ScheduleContent(ctx context.Context, params *crm_grpc_adapter.ScheduleContentParams) (*crm_grpc_adapter.ScheduleContentAdapterResult, error)
	ListScheduledContent(ctx context.Context, params *crm_grpc_adapter.ListScheduledContentParams) (*crm_grpc_adapter.ListScheduledContentResult, error)
	GetContentAnalytics(ctx context.Context, params *crm_grpc_adapter.GetContentAnalyticsParams) (*crm_grpc_adapter.ContentAnalyticsAdapterResult, error)
	CreateAgentLead(ctx context.Context, params *crm_grpc_adapter.CreateAgentLeadParams) (*crm_grpc_adapter.AgentLeadAdapterResult, error)
	ListAgentLeads(ctx context.Context, params *crm_grpc_adapter.ListAgentLeadsParams) (*crm_grpc_adapter.ListAgentLeadsResult, error)
	SetLeadReminder(ctx context.Context, params *crm_grpc_adapter.SetLeadReminderParams) (*crm_grpc_adapter.SetLeadReminderAdapterResult, error)
	ListLeadReminders(ctx context.Context, leadId string) (*crm_grpc_adapter.ListLeadRemindersResult, error)
	FilterBotLeads(ctx context.Context, agentId string) (*crm_grpc_adapter.FilterBotLeadsAdapterResult, error)
	CreateDripSequence(ctx context.Context, params *crm_grpc_adapter.CreateDripSequenceParams) (*crm_grpc_adapter.DripSequenceAdapterResult, error)
	ListDripSequences(ctx context.Context, params *crm_grpc_adapter.ListDripSequencesParams) (*crm_grpc_adapter.ListDripSequencesResult, error)
	CreateMomentTrigger(ctx context.Context, params *crm_grpc_adapter.CreateMomentTriggerParams) (*crm_grpc_adapter.MomentTriggerAdapterResult, error)
	CreateSegment(ctx context.Context, params *crm_grpc_adapter.CreateSegmentParams) (*crm_grpc_adapter.SegmentAdapterResult, error)
	ListSegments(ctx context.Context, params *crm_grpc_adapter.ListSegmentsParams) (*crm_grpc_adapter.ListSegmentsResult, error)
	SendBroadcast(ctx context.Context, params *crm_grpc_adapter.SendBroadcastParams) (*crm_grpc_adapter.SendBroadcastAdapterResult, error)
	AssignLeadFair(ctx context.Context, params *crm_grpc_adapter.AssignLeadFairParams) (*crm_grpc_adapter.AssignLeadFairAdapterResult, error)
	CreateSlaRule(ctx context.Context, params *crm_grpc_adapter.CreateSlaRuleParams) (*crm_grpc_adapter.SlaRuleAdapterResult, error)
	GetLeadTrail(ctx context.Context, leadId string) (*crm_grpc_adapter.GetLeadTrailAdapterResult, error)
	TagLead(ctx context.Context, params *crm_grpc_adapter.TagLeadParams) (*crm_grpc_adapter.TagLeadAdapterResult, error)
	GenerateQuote(ctx context.Context, params *crm_grpc_adapter.GenerateQuoteParams) (*crm_grpc_adapter.QuoteAdapterResult, error)
	GetQuote(ctx context.Context, quoteId string) (*crm_grpc_adapter.QuoteAdapterResult, error)
	BuildPaymentLink(ctx context.Context, params *crm_grpc_adapter.BuildPaymentLinkParams) (*crm_grpc_adapter.PaymentLinkAdapterResult, error)
	RequestDiscount(ctx context.Context, params *crm_grpc_adapter.RequestDiscountParams) (*crm_grpc_adapter.DiscountAdapterResult, error)
	ApproveDiscount(ctx context.Context, params *crm_grpc_adapter.ApproveDiscountParams) (*crm_grpc_adapter.DiscountAdapterResult, error)
	GetStaleProspects(ctx context.Context, params *crm_grpc_adapter.GetStaleProspectsParams) (*crm_grpc_adapter.GetStaleProspectsResult, error)
	GetCommissionBalance(ctx context.Context, agentId string) (*crm_grpc_adapter.CommissionBalanceAdapterResult, error)
	GetCommissionEvents(ctx context.Context, agentId string) (*crm_grpc_adapter.GetCommissionEventsAdapterResult, error)
	RequestPayout(ctx context.Context, params *crm_grpc_adapter.RequestPayoutParams) (*crm_grpc_adapter.PayoutAdapterResult, error)
	GetPayoutHistory(ctx context.Context, agentId string) (*crm_grpc_adapter.GetPayoutHistoryAdapterResult, error)
	ComputeOverrideCommission(ctx context.Context, params *crm_grpc_adapter.ComputeOverrideParams) (*crm_grpc_adapter.OverrideCommissionAdapterResult, error)
	GetRoasReport(ctx context.Context, params *crm_grpc_adapter.GetRoasReportParams) (*crm_grpc_adapter.RoasReportAdapterResult, error)
	ListAcademyCourses(ctx context.Context, params *crm_grpc_adapter.ListAcademyCoursesParams) (*crm_grpc_adapter.ListAcademyCoursesResult, error)
	GetCourseProgress(ctx context.Context, params *crm_grpc_adapter.GetCourseProgressParams) (*crm_grpc_adapter.CourseProgressAdapterResult, error)
	SubmitQuiz(ctx context.Context, params *crm_grpc_adapter.SubmitQuizParams) (*crm_grpc_adapter.QuizAdapterResult, error)
	ListSalesScripts(ctx context.Context, params *crm_grpc_adapter.ListSalesScriptsParams) (*crm_grpc_adapter.ListSalesScriptsResult, error)
	GetLeaderboard(ctx context.Context, params *crm_grpc_adapter.GetLeaderboardParams) (*crm_grpc_adapter.LeaderboardAdapterResult, error)
	GetAgentTier(ctx context.Context, agentId string) (*crm_grpc_adapter.AgentTierAdapterResult, error)
	GetAlumniReferrals(ctx context.Context, agentId string) (*crm_grpc_adapter.GetAlumniReferralsAdapterResult, error)
	GetReturnIntentSavings(ctx context.Context, agentId string) (*crm_grpc_adapter.ReturnIntentAdapterResult, error)
	CalculateZakat(ctx context.Context, params *crm_grpc_adapter.CalculateZakatParams) (*crm_grpc_adapter.ZakatAdapterResult, error)
	RecordCharity(ctx context.Context, params *crm_grpc_adapter.RecordCharityParams) (*crm_grpc_adapter.CharityAdapterResult, error)
}
