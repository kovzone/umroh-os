...
// jamaah-svc pilot scaffold exposes only the three standard scaffold endpoints:
//
//   - GET /system/live
//   - GET /system/ready
...
// runGrpcServer runs the gRPC server exposing the JamaahService surface plus the
