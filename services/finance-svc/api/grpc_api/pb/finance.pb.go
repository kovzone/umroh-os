...
const file_finance_proto_rawDesc = "" +
	"\n" +
	"\rfinance.proto\x12\x02pb\"\x10\n" +
	"\x0eHealthzRequest\"!\n" +
	"\x0fHealthzResponse\x12\x0e\n" +
	"\x02ok\x18\x01 \x01(\bR\x02ok2F\n" +
	"\x0eFinanceService\x124\n" +
...
var file_finance_proto_depIdxs = []int32{
	0, // 0: pb.FinanceService.Healthz:input_type -> pb.HealthzRequest
	1, // 1: pb.FinanceService.Healthz:output_type -> pb.HealthzResponse
