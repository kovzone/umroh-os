...
// runGrpcServer runs the gRPC server exposing the CrmService surface plus
// the standard gRPC health protocol. Per ADR 0009 this is crm-svc's only
// transport — REST was removed in BL-REFACTOR-003 / S1-E-13.
func runGrpcServer(address string, apiServer *grpc_api.Server) *grpc.Server {
	...
	pb.RegisterCrmServiceServerWithDepth(grpcServer, apiServer)
