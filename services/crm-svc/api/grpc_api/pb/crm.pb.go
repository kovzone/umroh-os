...
var file_crm_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
var file_crm_proto_depIdxs = []int32{
	0, // 0: pb.CrmService.Healthz:input_type -> pb.HealthzRequest
	1, // 1: pb.CrmService.Healthz:output_type -> pb.HealthzResponse
