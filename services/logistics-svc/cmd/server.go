...
import (
	...
	"logistics-svc/api/rest_oapi"
	"logistics-svc/api/rest_oapi/middleware"
...
// logistics-svc pilot scaffold exposes only the three standard scaffold endpoints:
//
//   - GET /system/live
//   - GET /system/ready
...
func runRestServer(port int, api rest_oapi.ServerInterface, metricsEnabled bool, serviceName string) {
	...
	// to scan (e.g. "logistics-svc GET /system/diagnostics/db-tx").
...
// runGrpcServer runs the gRPC server exposing the LogisticsService surface plus the
