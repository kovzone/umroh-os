...
// runGrpcServer runs the gRPC server exposing the LogisticsService surface plus
// the standard gRPC health protocol. Per ADR 0009 this is logistics-svc's only
// transport — REST was removed in BL-REFACTOR-005 / S1-E-13.
