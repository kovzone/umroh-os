...
import (
	...
	"ops-svc/api/rest_oapi"
	"ops-svc/api/rest_oapi/middleware"
	"ops-svc/util/monitoring"
...
// ops-svc pilot scaffold exposes only the three standard scaffold endpoints:
//
//   - GET /system/live
//   - GET /system/ready
...
func runRestServer(port int, api rest_oapi.ServerInterface, metricsEnabled bool, serviceName string) {
	...
	// to scan (e.g. "ops-svc GET /system/diagnostics/db-tx").
...
// runGrpcServer runs the gRPC server exposing the OpsService surface plus the
