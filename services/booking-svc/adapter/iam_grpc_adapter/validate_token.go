...
// middleware renders the same envelope as native booking-svc errors. Unauthenticated
...
// sentinel the booking-svc error middleware can render. The default branch is
