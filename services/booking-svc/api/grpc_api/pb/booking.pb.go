...
var file_booking_proto_depIdxs = []int32{
	0, // 0: pb.BookingService.Healthz:input_type -> pb.HealthzRequest
	1, // 1: pb.BookingService.Healthz:output_type -> pb.HealthzResponse
