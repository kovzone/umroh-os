...
- Name: 06-uat-s3s4-crm-ops.spec.ts >> S4 CRM — Lead Capture (BL-CRM-001) >> S4-LEAD-01: POST /v1/leads (public) → 201, lead tersimpan
- Location: tests/06-uat-s3s4-crm-ops.spec.ts:47:7
