...
- Name: 04-uat-s1-auth-catalog.spec.ts >> S1 Catalog — Staff Write (BL-CAT-014) >> S1-WRITE-01: POST /v1/packages (staff) → 201, package terbuat dengan status draft/active
- Location: tests/04-uat-s1-auth-catalog.spec.ts:264:7
